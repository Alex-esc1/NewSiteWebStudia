                ...
                <nav
                  ...
                  <div className="header-nav-inner">
                    <ul className={
                      ...
                      <li>
                        <Link to="/secondary/" onClick={this.closeMenu}>Contact</Link>
                      </li>
                    </ul>
                    {!hideSignin &&
                      <ul
                      ...
                      >
                        <li>
                          <Link to="/signup/" className="button button-dark button-wide-mobile button-sm" onClick={this.closeMenu}>leave a message</Link>
                        </li>
                      </ul>}
                  </div>
                </nav>
